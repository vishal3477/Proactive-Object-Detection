...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default='/mnt/ufs18/nodr/home/asnanivi/cod/cod_2/TestDataset/')
    parser.add_argument(
        '--pred_root', type=str, help='prediction root',
        default='/mnt/ufs18/home-188/asnanivi/Desktop/pro_obj_det/a100/DGNet/lib_pytorch/result/proactive/loc_encoder')
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=['DGNet'])#['Exp-DGNet-S', 'Exp-DGNet', 'Exp-DGNet-PVTv2-B0', 'Exp-DGNet-PVTv2-B1', 'Exp-DGNet-PVTv2-B2', 'Exp-DGNet-PVTv2-B3'])
